...
$options = array( 'site'=>'site', 'type'=>'components', 'ext'=>'com_wepay' );

// Require the base controller
Wepay::load( 'WepayController', 'controller', $options );

// Require specific controller if requested
$controller = JRequest::getWord('controller', JRequest::getVar( 'view' ) );
if (!Wepay::load( 'WepayController'.$controller, "controllers.$controller", $options ))
    $controller = '';
