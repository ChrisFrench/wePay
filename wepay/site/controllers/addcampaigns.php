...
if (!class_exists('WepayControllerCampaigns')) {
	JLoader::register("WepayControllerCampaigns", JPATH_ADMINISTRATOR . "/components/com_wepay/controllers/campaigns.php");
}

class WepayControllerCampaignsAdd extends WepayControllerCampaigns {
